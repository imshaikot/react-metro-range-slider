...
var ReactRangeSlider = function (_React$Component) {
  ...
  _createClass(ReactRangeSlider, [{
    ...
    value: function render() {
      ...
      var colors = this.props.disabled ? { toFill: '#babbbc',
...
ReactRangeSlider.propTypes = {
  ...
  onPreModal: _propTypes2.default.func,

  preValue: _propTypes2.default.number,
  min: _propTypes2.default.number,
  max: _propTypes2.default.number,
  disabled: _propTypes2.default.bool,
  /* eslint-disable */
  colorPalette: _propTypes2.default.object
  /* eslint-enable */
};
